...
public class GengarChar extends CharacterImpl {
	...
	public void render(GraphicsContext gc) {
		...
		if(_gunkex){
		if(_gunk.getY() + _gunk.getHeight() >= 400 || _gunk.isGone() && _counter >5) {
			_gunk.explode();
			_gunkex = false;
			_gunkcounter = 0;
		}
	...
	public void attack1() {
		...
		if(!_attack1 && _charge<30) {
			...
			Hitbox attack;
			if (_facing.equals("right")) {
				attack = new HitboxImpl("shadowball", this, false, _x + 80, _y + 35, 35, 20, 23, 0, 3, _charge * 1.2, new Image("gengar/ballw.png"));
			} else {
				attack = new HitboxImpl("shadowball", this, false, _x - 35, _y + 35, 35, 20, -23, 0, 3, _charge * 1.2, new Image("gengar/ballwleft.png"));
			}
			...
			Hitbox attack;
			if (_facing.equals("right")) {
				attack = new HitboxImpl("shadowball", this, false, _x + 80, _y + 30, 60, 30, 18, 0, 10, _charge * 1.2, new Image("gengar/ballm.png"));
			} else {
				attack = new HitboxImpl("shadowball", this, false, _x - 60, _y + 30, 60, 30, -18, 0, 10, _charge * 1.2, new Image("gengar/ballmleft.png"));
			}
			TheGame._attacks.add(attack);
			_charge = 0;
	...
	public void attack3() {
		boolean b = true;
		for (Hitbox a : TheGame._attacks) {
			if (a.getID().equals("gunk") ||a.getID().equals("gunk2")  && a.getCharacter().equals(this)) {
				b = false;
			}
	...
	public void executeAttackU() {
		...
		if(_counter >= 60 && _counter < 76) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty += 20;
			
		}
		if(_counter >= 76 && _counter < 94) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty -= 20;
			
		}
		if(_counter >= 94 && _counter < 113 ) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty += 20;
			
		}
		if(_counter >= 113 && _counter < 132 ) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty -= 20;
			
		}
		if(_counter >= 132 && _counter < 151) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty += 20;
			
		}
		if(_counter >= 151 && _counter < 170) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty -= 20;
			
		}
		if(_counter >= 170 && _counter < 189) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty += 20;
			
		}
		if(_counter >= 189 && _counter < 208) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty -= 20;
			
		}
		if(_counter >= 208 && _counter < 227) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty += 20;
			
		}
		if(_counter >= 227 && _counter < 246) {
			TheGame._attacks.add(new HitboxImpl("ultball", this, false, x, _ulty, 80, 40, v, 0, 0, 5, i));
			_ulty -= 20;
